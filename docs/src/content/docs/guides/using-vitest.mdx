...
[Vitest](https://vitest.dev/) is a modern JavaScript testing framework that integrates with the [Vite](https://vite.dev/) bundler. It is recommended for developers that are already using [Vite](https://vite.dev/) or [Vitest](https://vitest.dev/) on their project.
...
<Tabs>
  <TabItem label="npm" icon="npm">
    <Code lang="shell" code="npm i -D vitest @types/node" />
  </TabItem>
  <TabItem label="pnpm" icon="pnpm">
    <Code lang="shell" code="pnpm i -D vitest @types/node" />
  </TabItem>
  <TabItem label="bun" icon="bun">
    <Code lang="shell" code="bun add -d vitest @types/node" />
  </TabItem>
  <TabItem label="yarn" icon="seti:yarn">
    <Code lang="shell" code="yarn add -D vitest @types/node" />
  </TabItem>
</Tabs>
