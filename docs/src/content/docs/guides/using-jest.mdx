...
<Tabs>
  <TabItem label="npm" icon="npm">
    <Code lang="shell" code="npm i -D jest @types/jest @types/node @swc/core @swc/jest" />
  </TabItem>
  <TabItem label="pnpm" icon="pnpm">
    <Code lang="shell" code="pnpm i -D jest @types/jest @types/node @swc/core @swc/jest" />
  </TabItem>
  <TabItem label="bun" icon="bun">
    <Code lang="shell" code="bun add -d jest @types/jest @types/node @swc/core @swc/jest" />
  </TabItem>
