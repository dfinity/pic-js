...
<Tabs>
  <TabItem label="npm" icon="npm">
    <Code lang="shell" code="npm i -D @types/bun" />
  </TabItem>
  <TabItem label="pnpm" icon="pnpm">
    <Code lang="shell" code="pnpm i -D @types/bun" />
  </TabItem>
  <TabItem label="bun" icon="bun">
    <Code lang="shell" code="bun add -d @types/bun" />
  </TabItem>
  <TabItem label="yarn" icon="seti:yarn">
    <Code lang="shell" code="yarn add -D @types/bun" />
  </TabItem>
</Tabs>
