...
/**
 * Options for creating an {@link Actor} or a {@link DeferredActor} for an existing canister.
 *
 * @category Types
...
export interface CreateActorOptions {
  /**
   * The interface factory of the canister, as generated by `@icp-sdk/bindgen`.
   */
  ...
  /**
   * The Principal to make calls as. Defaults to the anonymous principal.
   * It can be changed later with `setPrincipal` or `setIdentity` on the actor.
   */
  sender?: Principal;
}

//#endregion CreateActor
